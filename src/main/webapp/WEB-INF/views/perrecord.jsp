...
.container {
    ...
    animation: slideIn 1.5s ease-out; /* Slide-in effect for the container */
}
...
.table {
    ...
    animation: slideInTable 1.5s ease-out;
}
...
.card {
    ...
    transition: transform 0.3s ease-in-out; /* Hover effect on cards */
}
